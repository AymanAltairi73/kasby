-- Extend notifications.type CHECK constraint for enterprise KYC / account notifications.
-- Fixes: notifications_type_check violation on KYC approval (permission_* types).
...
-- Route new notification types for deep-link navigation.
