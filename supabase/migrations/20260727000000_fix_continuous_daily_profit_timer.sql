-- ============================================================
-- Migration: Fix Continuous Daily Profit Timer & Cycle Calculation
-- ============================================================

-- Backfill any active investments that currently have next_payout_at IS NULL or in the past
UPDATE public.user_investments
SET next_payout_at = NOW() + INTERVAL '24 hours'
WHERE status = 'active' AND (next_payout_at IS NULL OR next_payout_at <= NOW());
...
BEGIN
    ...
    LOOP
        ...
        -- Update investment cycle and payout history to immediately start next 24h cycle
        UPDATE public.user_investments
