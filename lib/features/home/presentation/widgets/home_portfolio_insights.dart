  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
            ...
            child: Column(
              ...
              children: [
                ...
                KasbySparkline(
                  data: data,
                  height: 64,
                  lineColor: isPositive ? AppColors.softGreen : AppColors.error,
                ),
              ],
            ),
          );
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor:
                        AlwaysStoppedAnimation<Color>(AppColors.darkGold),
                  ),
                ),
                const SizedBox(height: 8),
                Row(
        ...
        .fadeIn(
          delay: KasbyMotion.duration(context, const Duration(milliseconds: 900)),
        );
  }
}
