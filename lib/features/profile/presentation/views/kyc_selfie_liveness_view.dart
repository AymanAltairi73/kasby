...
class _KycSelfieLivenessViewState extends State<KycSelfieLivenessView>
            ...
            children: [
              ...
              LayoutBuilder(
                builder: (context, constraints) {
                  final geometry = KycGuideGeometry.forSize(constraints.biggest);
                  return Obx(() {
    ...
    return Obx(
      () {
        ...
        return AnimatedSwitcher(
          ...
          child: Container(
            key: ValueKey(
              '${controller.currentAngleIndex.value}_$showSuccess',
            ),
  ...
  Widget _buildBottomActions(ThemeData theme) {
    return Obx(
      () {
        final canCapture = !controller.isCapturing.value &&
            !controller.showCaptureSuccess.value;
        return Container(
          width: double.infinity,
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      onPressed: canCapture ? controller.retakeCurrentAngle : null,
                  ...
                  Expanded(
                    ...
                    child: KasbyButton(
                      ...
                      onPressed: canCapture ? controller.captureCurrentAngle : null,
                    ),
                  ),
                ],
              ),
