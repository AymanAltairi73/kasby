-- ============================================================================
-- SQL SCRIPT: fix_profit_distribution_and_notifications.sql
-- Date: 2026-09-20
-- Description: Run this script in Supabase Dashboard SQL Editor
--   1. Fix fn_cron_distribute_daily_profits (changes 'investment_profit' to canonical 'profit')
--   2. Add duplicate payout protection guard (20h window)
--   3. Enhance fn_localize_notification_before_insert for profit localization
--   4. Enhance trigger_generic_notification for true multi-device FCM push delivery
-- ============================================================================
